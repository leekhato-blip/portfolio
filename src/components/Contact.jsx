    ...
    >
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        <div className="mt-6 flex items-center justify-center gap-6 text-2xl">
          ...
          <motion.a href="https://www.instagram.com/katoabdulsalamii?igsh=MTFkb3pnNHFkNnN5OA==" target="_blank" aria-label="Instagram" whileHover={{ scale: 1.15, color: "#a855f7" }} className="text-purple-300 transition">
            <FaInstagram />
          </motion.a>
        </div>
      </div>
